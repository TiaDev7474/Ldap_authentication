...
import illustration from '../undraw_join_re_w1lh.svg';
      ...
      <div className="bg-white rounded-lg shadow-lg p-4 w-[30%] h-[100vh]">
        <div className="border border-gray-300 p-4">
          ...
          <div className="mt-5 pl-[16%]">
            <p className="text-lg font-semibold">Numéro matricule: 1525H-F</p>
            <p className="text-sm">
              Niveau : License professionnelle de niveau 2
            </p>
          </div>
        </div>
        <nav className="mt-4">
